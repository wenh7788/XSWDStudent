...
public class NewTechserCommentPageView extends LinearLayout
{
    ...
    private NewTecherCommentListAdapter mAdapter;
   // private Myadapter  TimeAdapter;
    ...
    public NewTechserCommentPageView(Context context)
    {
        super(context);
        init(context);
        setDate();
    ...
    private void init(Context context)
    {
        ...
        mAdapter = new NewTecherCommentListAdapter(mContext, mList);
