...
import com.ai.xswdstudent.adapter.AllOrderListAdapter;
import com.ai.xswdstudent.adapter.NewTecherCommentListAdapter;
import com.ai.xswdstudent.model.ExamItem;



public class AllorederPageView extends LinearLayout
{
   ...
   // private Myadapter  TimeAdapter;
    ...
    public AllorederPageView(Context context)
    {
        super(context);
        init(context);
        setDate();
    ...
    private void init(Context context)
    {
        ...
        mAdapter = new AllOrderListAdapter(mContext, mList);
