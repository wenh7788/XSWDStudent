...
public class CollectionListNoAdapter extends BaseAdapter
{
    ...
    public CollectionListNoAdapter(Context context,ArrayList<ExamItem> mList)
    {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (null == convertView)
        {
            ...
            convertView = mInflater.inflate(R.layout.my_collect_teacher_no_listview_item,
                    null);
